-- 添加封面图片字段
ALTER TABLE notice ADD COLUMN cover_image VARCHAR(500) COMMENT '封面图片URL' AFTER content;

-- 插入测试公告数据
INSERT INTO notice (title, content, cover_image, notice_type, publisher_id, publish_time, end_time, status, view_count, create_time) VALUES
